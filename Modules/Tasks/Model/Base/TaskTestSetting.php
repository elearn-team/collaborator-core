 ...
 */
/**
 * Data model for table "els_tasks_test_settings"
 *
 * @category  DataModels
 * @package   DataModel
 * @author    Bazalt CMS (http://bazalt-cms.com/)
...
abstract class TaskTestSetting extends \Bazalt\ORM\Record
{
    const TABLE_NAME = 'els_tasks_test_settings';

    const MODEL_NAME = 'Modules\\Tasks\\Model\\TaskTestSetting';
    ...
    {
        $this->hasColumn('task_id', 'PU:int(10)');
