 ...
 */
/**
 * Data model for table "els_courses_plan"
 *
 * @category  DataModels
 * @package   DataModel
 * @author    Bazalt CMS (http://bazalt-cms.com/)
...
abstract class CoursePlan extends \Bazalt\ORM\Record
{
    const TABLE_NAME = 'els_courses_plan';

    const MODEL_NAME = 'Modules\\Courses\\Model\\CoursePlan';
    ...
    protected function initFields()
    {
        ...
        $this->hasColumn('start_element', 'U:tinyint(1)');
        $this->hasColumn('is_determ_final_mark', 'U:tinyint(1)');
