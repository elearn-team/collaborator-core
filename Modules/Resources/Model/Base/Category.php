...
{
    const TABLE_NAME = 'els_resource_categories';

    const MODEL_NAME = 'Modules\\Resources\\Model\\Category';
    ...
    {
        $this->hasRelation('Elements', new \Bazalt\ORM\Relation\NestedSet('Modules\\Resources\\Model\\Category', 'site_id'));
        $this->hasRelation('PublicElements',
            new \Bazalt\ORM\Relation\NestedSet('Modules\\Resources\\Model\\Category', 'site_id', null, ['is_hidden' => '0', 'is_published' => 1]));
    }
